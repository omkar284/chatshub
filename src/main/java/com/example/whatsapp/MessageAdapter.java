    ...
    public void onBindViewHolder(@NonNull MessageViewHolder messageViewHolder, int position) {
        ...
        usersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    String receiverImage = dataSnapshot.child("profilepic").getValue().toString();
        ...
        else if (fromMessageType.equals("pdf") || fromMessageType.equals("docx"))
        {
            ...
            {
                messageViewHolder.messageSenderPicture.setVisibility(View.VISIBLE);
                messageViewHolder.messageSenderPicture.setBackgroundResource(R.drawable.file_1453);
                ...
                messageViewHolder.messageReceiverPicture.setBackgroundResource(R.drawable.file_1453);
