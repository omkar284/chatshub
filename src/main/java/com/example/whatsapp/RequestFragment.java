    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Contacts,RequestViewHolder> adapter = new FirebaseRecyclerAdapter<Contacts, RequestViewHolder>(options) {
                                ...
                                UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                     if (dataSnapshot.hasChild("profilepic"))
                                     {
                                         ...
                                         final String requestProfileImage = dataSnapshot.child("profilepic").getValue().toString();
            ...
            public RequestViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.users_dispaly_layout,viewGroup,false);
